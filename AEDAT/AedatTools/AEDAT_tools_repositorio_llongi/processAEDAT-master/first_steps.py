...
t,x,y,p = loadaerdat('C:\\Users\\Samsung\\Documents\\ObjectRecognition\\assets\\video_chave_fenda.aedat')

m = matrix_active(x[: 2500],y[: 2500],p[: 2500])
